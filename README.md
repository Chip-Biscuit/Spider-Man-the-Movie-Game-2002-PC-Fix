...
Delete (make sure you back them up somewhere else) or rename ACTIVISN.bik<br>
if you dont want any splash screen start up movies and get into the game faster then optionally also the following -> GrayMatr.bik, Origin1.bik and Treyarch.bik.
